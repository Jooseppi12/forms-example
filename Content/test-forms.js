...
{
 "use strict";
 var test_forms,Client,WebSharper,Operators,Obj,UI,Var,Forms,Form,Form1Data,SC$1,Pervasives,JavaScript,JS,Doc,View,Submitter,Client$1,Templates,Pervasives$1,State,_testforms_Router,Router,Fresh,Var$1,List,T,Snap,AttrProxy,Numeric,Strings,EventTarget,Node,Collections,Dictionary,Unchecked,Sitelets,RouterOperators,RouterModule,Route,Result,ConcreteVar,ErrorMessage,Docs,Seq,AttrModule,Attrs,DomUtility,SC$2,Arrays,HashSet,WindowOrWorkerGlobalScope,Router$1,List$1,Option,SC$3,Abbrev,Fresh$1,DocElemNode,CharacterData,Enumerator,T$1,BindVar,DictionaryUtil,Element,Object,Prepare,Slice,KeyCollection,An,Settings,Mailbox,FSharpMap,Map,Utils,Concurrency,Attrs$1,Dyn,Elt,Array,SC$4,Docs$1,RunState,NodeSet,Anims,SC$5,BalancedTree,Tree,Pair,SC$6,SC$7,Queue,Updates,String,CheckedInput,SC$8,SC$9,AppendList,StringEncoding,Char,System,Guid,MapUtil,Scheduler,PathUtil,DateUtil,DynamicAttrNode,Error,KeyNotFoundException,Easing,AsyncBody,SC$10,CT,HashSet$1,HashSetUtil,CancellationTokenSource,DomNodes,OperationCanceledException,Lazy,SC$11,LazyExtensionsProxy,LazyRecord,FormatException,Runtime,console,String$1,Date;
 test_forms=Global.test_forms=Global.test_forms||{};
 Client=test_forms.Client=test_forms.Client||{};
 ...
 Form1Data=Client.Form1Data=Client.Form1Data||{};
 SC$1=Global["StartupCode$test-forms$Client"]=Global["StartupCode$test-forms$Client"]||{};
 ...
 _testforms_Router=Global["test-forms_Router"]=Global["test-forms_Router"]||{};
 ...
 {
  var _;
  _=Doc.BindView(function(a)
  {
   return a.$==1?a.$0.$==1?Form.Render(function($1)
   {
    return function($2)
    {
     return Client.RenderForm2Case2($1,$2);
    };
   },Client.Form2Case2(a.$0.$0)):Form.Render(function($1)
   {
    return function($2)
    {
     return Client.RenderForm2Case1($1,$2);
    };
   },Client.Form2Case1(a.$0.$0)):Form.Render(Runtime.Curried3(Client.RenderForm1),Client.Form1(Form1Data.New("",0)));
  },Client.router().get_View());
 ...
 Client.Form2Case2=function(i)
 {
  return Form.Run(function(i$1)
  {
   Global.alert("Given: "+Global.String(i$1));
  },Form.WithSubmit(Pervasives.op_LessMultiplyGreater(Form.Return(Global.id),Form.Yield(i))));
 };
 Client.RenderForm2Case2=function(i,submit)
 {
  function a(a$1,a$2)
  {
   return submit.Trigger();
  }
  return Doc.Element("div",[],[Doc.IntInputUnchecked([],i),Doc.Element("button",[AttrProxy.HandlerImpl("click",function($1)
  {
   return function($2)
   {
    return a($1,$2);
 ...
 Client.Form2Case1=function(s)
 {
  return Form.Run(function(s$1)
  {
   Global.alert(s$1);
  },Form.WithSubmit(Pervasives.op_LessMultiplyGreater(Form.Return(Global.id),Form.Yield(s))));
 };
 Client.RenderForm2Case1=function(s,submit)
 {
  function a(a$1,a$2)
  {
   return submit.Trigger();
  }
  return Doc.Element("div",[],[Doc.Input([],s),Doc.Element("button",[AttrProxy.HandlerImpl("click",function($1)
  {
   return function($2)
   {
    return a($1,$2);
 ...
 Client.Form1=function(init)
 {
  return Form.Run(function(data)
  {
   if(Strings.Trim(data.String)!="")
    Client.router().Set({
     $:1,
     $0:{
      $:0,
  ...
  },Form.WithSubmit(Pervasives.op_LessMultiplyGreater(Pervasives.op_LessMultiplyGreater(Form.Return(function(a)
  {
   return function(a$1)
   {
    return Form1Data.Create(a,a$1);
   };
  }),Form.Yield(init.String)),Form.Yield(init.Int))));
 };
 Client.RenderForm1=function(s,i,submit)
 {
  function a(a$1,a$2)
  {
   return submit.Trigger();
  }
  return Doc.Element("div",[],[Doc.Element("p",[],[Doc.TextNode("If the string field is not empty, go to state2 with the string input otherwise go to state2 with the int input")]),Doc.Input([],s),Doc.IntInputUnchecked([],i),Doc.Element("button",[AttrProxy.HandlerImpl("click",function($1)
  {
   return function($2)
   {
    return a($1,$2);
   };
  })],[Doc.TextNode("Go to State 2")])]);
 };
 ...
 Form1Data.Create=function(s,i)
 {
  return Form1Data.New(s,i);
 };
 Form1Data.New=function(String$2,Int)
 {
  return{
   String:String$2,
   Int:Int
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.router=Router.InstallHash(State.Form1,_testforms_Router.r$1());
 };
 ...
 Doc.IntInputUnchecked=function(attr,_var)
 {
  return Doc.InputInternal("input",function()
  {
   return Seq.append(attr,[_var.Get()===0?AttrProxy.Create("value","0"):Attrs.EmptyAttr(),AttrModule.IntValueUnchecked(_var),AttrProxy.Create("type","number")]);
  });
 };
 ...
 _testforms_Router.r$1=function()
 {
  return RouterOperators.JSUnion(void 0,[[null,[[null,["Form1"]]],[]],[null,[[null,["Form2"]]],[_testforms_Router.r()]]]);
 };
 _testforms_Router.r=function()
 {
  return RouterOperators.JSUnion(void 0,[[null,[[null,["Case1"]]],[RouterOperators.rString()]],[null,[[null,["Case2"]]],[RouterOperators.rInt()]]]);
 };
 ...
 Docs.CreateElemNode=function(el,attr,children)
 {
  ...
  return DocElemNode.New(attr$1,children,null,el,Fresh$1.Int(),Runtime.GetOptional(attr$1.OnAfterRender));
 };
 ...
 StringEncoding.read=function(s)
 {
  ...
  return loop(List.ofSeq(Seq.map(function(v)
  {
   return v.charCodeAt();
  },s)));
 };
